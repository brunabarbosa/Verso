...
import com.projetoles.verso.LoginActivity;
				...
				mPoesiaController.post(poesia.getTitulo(), poesia.getAutor(),
						...
						new OnRequestListener<Poesia>(mContext) {
							...
							public void onSuccess(Poesia poesia) {
								if (!mUsuario.getPoesias().contains(
										poesia.getId())) {
													...
													public void onError(
														...
														ActivityUtils
																.showMessageDialog(
																		mContext,
																		"Um erro ocorreu",
																		"Não foi possível excluir esta poesia. Tente novamente",
																		null);
													}
												});
