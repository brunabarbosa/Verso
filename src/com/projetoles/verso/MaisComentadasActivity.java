...
import com.projetoles.model.NumComentariosComparator;
...
public class MaisComentadasActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		controller.getMaisComentadas(new OnRequestListener<ObjectListID<Poesia>>(this) {
			...
			public void onSuccess(ObjectListID<Poesia> result) {
				...
				mAdapter = new ExpandablePoesiaAdapter(MaisComentadasActivity.this, mExpListView, result, null, mLoading, mEmpty, 
						false, new NumComentariosComparator());
