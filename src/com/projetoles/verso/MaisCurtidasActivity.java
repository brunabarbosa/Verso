...
import com.projetoles.model.NumCurtidasComparator;
...
public class MaisCurtidasActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		controller.getMaisCurtidas(new OnRequestListener<ObjectListID<Poesia>>(this) {
			...
			public void onSuccess(ObjectListID<Poesia> result) {
				...
				mAdapter = new ExpandablePoesiaAdapter(MaisCurtidasActivity.this, mExpListView, result, null, mLoading, mEmpty, false, 
						new NumCurtidasComparator());
