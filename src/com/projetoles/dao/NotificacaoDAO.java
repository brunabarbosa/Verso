...
public class NotificacaoDAO extends DAO<Notificacao> {
	...
	public void post(Notificacao notificacao, OnRequestListener<String> callback) {
		POST.Builder postRequest = (POST.Builder) new POST.Builder()
			...
			.addParam("chave", "APA91bE1aZdsoDvSut4AHVYrU3jdUDD8bq4eRw2aBev4NMc6h0_Unpt56DOdD-4IXK1vJjt903XwpZFToDgGyHhFHzUJCibo4FtsUEqggFp96Zxsw8DkqF_w3AiEM-rZ9s0nQA9H0gxi")
			.setDomain(DOMAIN)
			.setPath("notif/post");
